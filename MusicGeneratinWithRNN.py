...
def generate_text(model, start_string, generation_length=1000):
  ...
  # Here batch size == 1
  # Access the LSTM layer by name and reset its states
  model.get_layer('lstm_2').reset_states() # Assuming the LSTM layer is named 'lstm_2'
